...
def distance(x, y):
    ...
    return math.sqrt(sum((x[i] - y[i]) ** 2 for i in range(len(x))))  # This sum() will iterate the (a[n] - b[n]) ^ 2 for the number of dimenstions (expantion of the dimensionality of the distance formula)
